...
// Do formats and executes the request. Returns io.Reader which could be used for streaming of the response, or an error
func (r *Request) Stream() (reader io.Reader, err error) {
