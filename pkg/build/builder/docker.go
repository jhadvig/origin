...
// appendMetadata appends and Docker instruction that adds metadata values
// to a string containing a valid Dockerfile.
func appendMetadata(inst MetaInstuction, fileData string, envVars map[string]string) string {
