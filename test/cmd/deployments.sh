...
os::cmd::expect_success_and_text 'oc env dc/test-deployment-config TEST=bar' 'nothing to update'
os::cmd::expect_success_and_text 'oc env dc/test-deployment-config BAR-' 'nothing to update'
echo "env: ok"
