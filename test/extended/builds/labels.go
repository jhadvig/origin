...
func ExpectOpenShiftLabels(labels map[string]string) error {
	ExpectedLabels := []string{
		"io.openshift.build.commit.git.author",
		"io.openshift.build.commit.git.date",
		"io.openshift.build.commit.git.id",
		"io.openshift.build.commit.git.ref",
		"io.openshift.build.commit.git.message",
